...
## Other
### "rubi"? "ruby"?
<sub>The name "rubi" is used to avoid confusion with the word "ruby".</sub><br>
"rubi"は"ruby"を意味します。
<sub>In the repository name, command name, etc., "rubi" is used to avoid confusion with the language "ruby".</sub><br>
Ruby(言語)と混同することを防ぐため、リポジトリ名、コマンド名などには"rubi"を使用しています。
<sub>In other cases, it is generally used as "ruby" (e.g. document, etc.).</sub><br>
その他の場合には、基本的には"ruby"を使用するようにしてください。(ドキュメントなど)

## Build

<sub>This program is developed in the following environment. (as of 2026/04/26)</sub><br>
本プログラムは下記の環境で開発しています。(2026/04/26時点)<br>

- Windows 11 (Build 26200)
- Neovim 0.12.2
- WezTerm Nightly

<sub>Currently, verification is performed based on this setting. (as of 2026/04/26)</sub><br>
現在はこちらの設定に基づいた環境で検証を行っています。(2026/04/26時点)<br>
